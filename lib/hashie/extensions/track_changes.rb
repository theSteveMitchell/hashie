# Modified from https://github.com/archan937/dirty_hashy
module Hashie 
  module Extensions
    # TrackChanges allows you to very basically track changes made to a Hash.
    #
    # @example
    #   class User < Hash
    ...
    #
    #   user.changes # => { :first_name => 'Steven' } 
